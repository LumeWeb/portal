...
func (_c *MockWorkflowCoordinator_FailWorkflowStep_Call) Return(err error) *MockWorkflowCoordinator_FailWorkflowStep_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockWorkflowCoordinator_FailWorkflowStep_Call) RunAndReturn(run func(ctx context.Context, requestID uint, reason string) error) *MockWorkflowCoordinator_FailWorkflowStep_Call {
	_c.Call.Return(run)
	return _c
}
